...
class MediumIntegerType implements ColumnType
{
    ...
    public function createMigrationMethod(ColumnName $columnName): string
    {
        if ($this->autoIncrement && $this->unsigned) {
            return sprintf("->mediumInteger('%s', true, true)", $columnName->getName());
        } elseif ($this->autoIncrement && $this->unsigned === false) {
            return sprintf("->mediumInteger('%s', true)", $columnName->getName());
        } elseif ($this->autoIncrement === false && $this->unsigned) {
            return sprintf("->mediumInteger('%s', false, true)", $columnName->getName());
        }
